...
var utils = {
  ...
  isArray: function (value) {
    debug && window.marker && console.error('isArray', arguments);
  ...
  isNumber: function (value) {
    debug && window.marker && console.error('isNumber', arguments);
  ...
  isString: function (value) {
    debug && window.marker && console.error('isString', arguments);
  ...
  isFunction: function (value) {
    debug && window.marker && console.error('isFunction', arguments);
  ...
  isUndefined: function (value) {
    debug && window.marker && console.error('isUndefined', arguments);
  ...
  isNull: function (value) {
    debug && window.marker && console.error('isNull', arguments);
  ...
  isSet: function (value) {
    debug && window.marker && console.error('isSet', arguments);
  ...
  isCell: function (value) {
    debug && window.marker && console.error('isCell', arguments);
  ...
  isFormula: function (value) {
    debug && window.marker && console.error('isFormula', arguments);
  ...
  getCellAlphaNum: function (cell) {
    debug && window.marker && console.error('getCellAlphaNum', arguments);
  ...
  changeRowIndex: function (cell, counter) {
    debug && window.marker && console.error('changeRowIndex', arguments);
  ...
  changeColIndex: function (cell, counter) {
    debug && window.marker && console.error('changeColIndex', arguments);
    var alphaNum = utils.getCellAlphaNum(cell),
        alpha = alphaNum.alpha,
  ...
  changeFormula: function (formula, delta, change) {
    debug && window.marker && console.error('changeFormula', arguments);
    if (!delta) {
      delta = 1;
    }
  ...
  updateFormula: function (formula, direction, delta) {
    debug && window.marker && console.error('updateFormula', arguments);
    var type,
        counter;
   ...
   */
  toNum: function (chr) {
    debug && window.marker && console.error('toNum', arguments);
...
//      return result;
   ...
   */
  toChar: function (num) {
    debug && window.marker && console.error('toChar', arguments);
    var s = '';
  ...
  cellCoords: function (cell) {
    debug && window.marker && console.error('cellCoords', arguments);
    var num = cell.match(/\d+$/),
        alpha = cell.replace(num, '');
  ...
  clearFormula: function (formula) {
    debug && window.marker && console.error('clearFormula', arguments);
  ...
  translateCellCoords: function (coords) {
    debug && window.marker && console.error('translateCellCoords', arguments);
    return utils.toChar(coords.col) + '' + parseInt(coords.row + 1, 10);
  },

  sort: function (rev) {
    debug && window.marker && console.error('sort', arguments);
    return function (a, b) {
